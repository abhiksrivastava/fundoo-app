...
# Note: We do the following so that app of the framework can use this style:
#
...
class Serializer(BaseSerializer, metaclass=SerializerMetaclass):
    ...
    def get_fields(self):
        ...
        # This allows app to dynamically modify the fields on a serializer
...
def raise_errors_on_nested_writes(method_name, serializer, validated_data):
    """
    Give explicit errors when app attempt to pass writable nested data.
