...
class URLPathVersioning(BaseVersioning):
    ...
    urlpatterns = [
        url(r'^(?P<version>[v1|v2]+)/app/$', users_list, name='app-list'),
        url(r'^(?P<version>[v1|v2]+)/app/(?P<pk>[0-9]+)/$', users_detail, name='app-detail')
    ]
...
class NamespaceVersioning(BaseVersioning):
    ...
    # app/urls.py
    urlpatterns = [
        url(r'^/app/$', users_list, name='app-list'),
        url(r'^/app/(?P<pk>[0-9]+)/$', users_detail, name='app-detail')
    ]

    # urls.py
    urlpatterns = [
        url(r'^v1/', include('app.urls', namespace='v1')),
        url(r'^v2/', include('app.urls', namespace='v2'))
    ]
