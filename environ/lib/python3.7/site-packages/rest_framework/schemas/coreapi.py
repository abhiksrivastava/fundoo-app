...
class SchemaGenerator(BaseSchemaGenerator):
    ...
    def get_keys(self, subpath, method, view):
        ...
        /app/                   ("app", "list"), ("app", "create")
        /app/{pk}/              ("app", "read"), ("app", "update"), ("app", "delete")
        /app/enabled/           ("app", "enabled")  # custom viewset list action
        /app/{pk}/star/         ("app", "star")     # custom viewset detail action
        /app/{pk}/groups/       ("app", "groups", "list"), ("app", "groups", "create")
        /app/{pk}/groups/{pk}/  ("app", "groups", "read"), ("app", "groups", "update"), ("app", "groups", "delete")
        """
        ...
        if is_custom_action(action):
            # Custom action, eg "/app/{pk}/activate/", "/app/active/"
